/*
Prerequisites
This tutorial requires the TPC-DS sample schema provided 
by Snowflake. If you don't already have this in your account,
please add it from the Snowflake Marketplace.
For information about the queries and data set, see the 
TPC-DS Benchmark specification:
http://tpc.org/tpc_documents_current_versions/pdf/tpc-ds_v3.2.0.pdf.

The business questions answered by these queries are
described in Appendix B: Business Questions. TPC also provides tools 
to generate all 99 queries with varied parameter values. The full
benchmark kit can be downloaded here:
http://www.tpc.org/tpc_documents_current_versions/current_specifications.asp.
This is a sample set of the 99 queries used in the TPC-DS benchmark.
